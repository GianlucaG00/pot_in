 ...
 */
#ifndef __included_srv6_pot_in_h__
#define __included_srv6_pot_in_h__
...
} srv6_pot_in_localsid_t;

extern srv6_pot_in_main_t srv6_pot_in_main;

format_function_t format_srv6_pot_in_localsid;
unformat_function_t unformat_srv6_pot_in_localsid;

void srv6_pot_in_dpo_lock (dpo_id_t * dpo);
void srv6_pot_in_dpo_unlock (dpo_id_t * dpo);

extern vlib_node_registration_t srv6_pot_in_localsid_node;

#endif /* __included_srv6_pot_in_h__ */
